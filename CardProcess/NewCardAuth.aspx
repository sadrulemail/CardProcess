                    ...
                    <asp:TemplateField HeaderText="Request Info" SortExpression="InsertBy">
                        <ItemTemplate>
                            ...
                            <div style="color: Silver; font-size: 85%">
                                <%# Eval("ReqBranchName","Req Branch:<div>{0}</div>")%>
                            </div>
                            <div runat="server" id="divauth" title="Auth Info" visible='<%# (Eval("Authorize").ToString().ToUpper() == "FALSE"?false:true) %>'>
                                Auth By:
                    ...
                    <asp:TemplateField HeaderText="">
                        <ItemTemplate>
                            <asp:Button ID="cmdAutorize" runat="server" Text="Authorize" CommandName="Authorize"
                                Visible='<%# (Eval("Authorize").ToString().ToUpper() == "FALSE" && Eval("ReqBranch").ToString()==Session["BRANCHID"].ToString() ? true : false) %>'
