<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PriorityPassCardSearch.aspx.cs" Inherits="PriorityPassCardSearch" EnableViewState="false" %>
        ...
        <ContentTemplate>
            <table class="Panel1 ui-corner-all">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtWaiveQtyGet" runat="server" Width="70px" placeholder="Waive Qty"></asp:TextBox>
                    </td>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="txtDateTo" Name="ToDate" PropertyName="Text"
                        Type="DateTime" DefaultValue="01/01/1900" />
                    <asp:ControlParameter ControlID="txtWaiveQtyGet" Name="WaiveQtyGet" PropertyName="Text"
