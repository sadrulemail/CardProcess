<%@ WebHandler Language="C#" Class="AttachmentCard" %>
...
public class AttachmentCard : IHttpHandler, IReadOnlySessionState
{
    string VIEW = "";
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (DR == null)
        {
            ...
            {
                string Query = "";
                Query = string.Format(string.Format("EXEC s_Attachments_Card_Image_Download '{0}', '{1}', '{2}', '{3}'"
                        , AID, FileID, EMPID, getIPAddress()
                    ));
