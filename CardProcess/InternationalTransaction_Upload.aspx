                                ...
                                <asp:TemplateField HeaderText="Download">
                                    <ItemTemplate>
                                        <div class='<%# Eval("Freeze").ToString().ToUpper() == "TRUE" ? "" : "hidden" %>'>
                                            ...
                                            <a href='InternationalTransactionView.aspx?batchid=<%# Eval("SL") %>&type=xlsx' target="_blank" class="Link">Report1(XLSX)</a>|
                                            <a href='InternationalTransactionView.aspx?batchid=<%# Eval("SL") %>&type=xlsx2' target="_blank" class="Link">Report2(XLSX)</a>|
                                            <a href='InternationalTransactionView.aspx?batchid=<%# Eval("SL") %>&type=xlsx3' target="_blank" class="Link">Reconcile Report(XLSX)</a>
                                        </div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
