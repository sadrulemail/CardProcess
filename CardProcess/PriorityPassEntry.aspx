    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" CssClass="Grid" AutoGenerateRows="False"
                ...
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="ITCLID" SortExpression="ITCLID">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtITCLID" runat="server" Text='<%# Bind("ITCLID") %>' Width="100px"
                    ...
                    <asp:TemplateField HeaderText="Card Number" SortExpression="CardNo">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtCardNo" runat="server" Text='<%# Bind("CardNo") %>' Width="200px"
                                MaxLength="100"></asp:TextBox>
                    ...
                    <asp:TemplateField HeaderText="Issue Date" HeaderStyle-Wrap="false">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtIssueDate" Width="90px" MaxLength="30" Class="Date" runat="server"
                    ...
                    <asp:TemplateField HeaderText="Expiry Date" HeaderStyle-Wrap="false">
                        ...
                        <EditItemTemplate>
                            <asp:TextBox ID="txtExpiryDate" Width="90px" MaxLength="30" Class="Date" runat="server"
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                SelectCommand="SELECT * FROM [PriorityPass] ORDER BY ID" OnSelected="SqlDataSource1_Selected"></asp:SqlDataSource>
        </ContentTemplate>
    </asp:UpdatePanel>
