            ...
            <asp:TabContainer runat="server" ID="tabContainer" CssClass="NewsTab" OnDemand="true"
                ...
                <asp:TabPanel runat="server" ID="tab2">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="Grid" AllowSorting="True" OnRowCommand="GridView1_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Card_IssueFee" HeaderText="Issue Fees" SortExpression="Card_IssueFee" />
                                ...
                                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Download">
                                    <ItemTemplate>
                                        <a href='<%# "Supplementary_Export_Download.aspx?CardType=" + Eval("CardType") + "&type=xlsx&batch=" + Eval("SL") %>' target="_blank"
                                            class="Link">XLSX</a> |  <a href='<%# "Supplementary_Export_Download.aspx?CardType=" + Eval("CardType") + "&type=xml&batch=" + Eval("SL") %>'
                                                target="_blank" class="Link">XML</a>| <a href='<%# "Supplementary_Export_Download.aspx?CardType=" + Eval("CardType") + "&type=view&batch=" + Eval("SL") %>'
                                                    target="_blank" class="Link">View</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Transfer">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="TransferBtn" CommandArgument='<%# Eval("SL") %>' Visible='<%# (decimal.Parse(Eval("Card_IssueFee").ToString()) >0 && Eval("TRANSFER").ToString() == "False"  ? true : false) %>'
                ...
                <asp:TabPanel runat="server" ID="tabNewExport">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" BackColor="White" ShowFooter="true"
                            OnDataBound="GridView6_DataBound" OnRowCommand="GridView6_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Branch Name" SortExpression="BranchName">
                                    <ItemTemplate>
                                        <a class="Link" target="_blank" href='Supplementary_Export_Download.aspx?type=view&cardtype=<%# DropDownList2.SelectedValue.ToString() %>&branch=<%# Eval("RequestBranchID") %>'>
                ...
                <asp:TabPanel runat="server" ID="tabDelete">
                    <HeaderTemplate>
                        Delete
                    </HeaderTemplate>
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" BackColor="White"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Account" SortExpression="Account">
                                    <ItemTemplate>
                                        <%# Eval("Account","<a href='Supplementary_Issue_Request.aspx?acc={0}' target='_blank'><b>{0}</b></a>")%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:Button runat="server" ID="cmdDelete1" CommandName="Delete" Text="Delete" Visible='<%# (Eval("SendDT", "{0:dd/MM/yyyy}").ToString() == Eval("CurrentDate", "{0:dd/MM/yyyy}").ToString() ? true : false) %>' />
                        ...
                        <asp:Label runat="server" ID="lblmsg1" Text="" Visible="false"></asp:Label>
                        <asp:SqlDataSource ID="SqlDataSourceSearch" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                            SelectCommand="s_Supplementary_Search" SelectCommandType="StoredProcedure" OnSelected="SqlDataSourceSearch_Selected" DeleteCommand="s_SupplementaryCardRequest_Delete_Mark"
