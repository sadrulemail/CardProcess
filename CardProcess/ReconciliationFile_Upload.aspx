...
<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ReconciliationFile_Upload.aspx.cs" Inherits="ReconciliationFile_Upload"
            ...
            <asp:TabContainer runat="server" ID="tabContainer" CssClass="NewsTab" OnDemand="true"
                ...
                <asp:TabPanel runat="server" ID="tab1">
                    ...
                    <ContentTemplate>
                                        ...
                                        <td>
                                            <div style="font-size: small; font-weight: bolder; padding: 10px 0px 3px 0px;">
                                                ...
                                                <asp:DropDownList ID="ddlFileType" runat="server">
                                                    ...
                                                    <asp:ListItem Text="Visa Off-Us" Value="Visa Off-Us"></asp:ListItem>
                                                    <asp:ListItem Text="ITCL Off-Us" Value="ITCL Off-Us"></asp:ListItem>
                                                    <asp:ListItem Text="NPSB" Value="NPSB"></asp:ListItem>
                                                </asp:DropDownList>
                                            ...
                                            <div style="font-size: small; font-weight: bolder; padding: 10px 0px 3px 0px;">
                                                Please select Reconciliation txt file:
                                            </div>
                        ...
                        <asp:Panel ID="PnlDuplicateChk" runat="server">
                            <div>
                                <fieldset class="fieldset" style="margin-left: 20px; width: 380px">
                                    <legend class="legend"><b>Duplicate Transaction(s) Found </b></legend>
                                    <asp:GridView ID="GridView4" runat="server" AllowSorting="True" BackColor="White"
                                        ...
                                        CellPadding="2" DataSourceID="SqlDataSource3" ForeColor="Black" AutoGenerateColumns="False"
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                                        SelectCommand="s_PosDuplicateTransactionCheck" SelectCommandType="StoredProcedure"
                                        OnSelected="SqlDataSource3_Selected">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="HidPageID" Name="SessionID" PropertyName="Value"
                                                Type="String" />
                                            <asp:ControlParameter ControlID="ddlFileType" Name="Type" PropertyName="SelectedValue"
                                                Type="String" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </fieldset>
                ...
                <asp:TabPanel runat="server" ID="tab3">
                    ...
                    <ContentTemplate>
                        <div runat="server" id="dskhdfsfhj" style="height: 400px">
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Merge Batch" Width="150px" Font-Bold="True"
                                Height="30px" OnClick="Button1_Click" CssClass="ui-corner-all" />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator245ret" runat="server" ControlToValidate="DropDownList2"
                                ErrorMessage="RequiredFieldValidator">*</asp:RequiredFieldValidator>
                        </div>
                    </ContentTemplate>
                </asp:TabPanel>
