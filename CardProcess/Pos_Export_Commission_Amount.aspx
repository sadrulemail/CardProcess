<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Pos_Export_Commission_Amount.aspx.cs" Inherits="Pos_Export_Commission_Amount" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:ConfirmButtonExtender ID="ddd" ConfirmText="Do You Download Again?" TargetControlID="btnDownload"
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                SelectCommand="SELECT CommissionDownloadCount FROM dbo.PosDownloadLog WHERE Batch=@DownloadBatch"
                SelectCommandType="Text" OnSelected="SqlDataSource1_Selected">
                <SelectParameters>
                    <asp:QueryStringParameter Name="DownloadBatch" QueryStringField="batch" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
