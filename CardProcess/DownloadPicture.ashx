<%@ WebHandler Language="C#" Class="DownloadPicture_Ashx" Debug="true" %>
...
public class DownloadPicture_Ashx : IHttpHandler, IReadOnlySessionState {
    ...
    {
        string BranchID = "1";// string.Format("{0}", context.Session["BRANCHID"]);
        if (BranchID != "1")
        {
            context.Response.Write("Not Head Office ." + BranchID);
