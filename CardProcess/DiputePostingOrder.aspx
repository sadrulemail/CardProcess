<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DiputePostingOrder.aspx.cs" Inherits="DiputePostingOrder" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="Panel1">
                <table>
                    <tr>
                        ...
                        <td>Posting:</td>
                        <td>
                            <asp:DropDownList ID="ddlPosting" runat="server" AppendDataBoundItems="true"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Download Letter">
                        <ItemTemplate>
                            ...
                            <div runat="server" id="divDownloadLetter" visible='<%# isDownloadLetterVisible(Eval("Authorize"),
                                    Eval("Approve"),Eval("ATM_Branch"), Eval("PostingBY"), Eval("BankCode"),Eval("ApproveDT"),
                                    Eval("PublishDate")) %>'>
                                <a href='DisputeLetterPrint.aspx?DisputeID=<%# Eval("ID") %>&SecretCode=<%# Eval("SecretCode") %>' title="Download letter after authorize"
                                    target="_blank" class="Link">
                                    <img alt="" height="32px" width="32px" src='Images/Distributor-report-icon.png' border="0" />
                                </a>
                            </div>
                    ...
                    <asp:TemplateField HeaderText="" HeaderStyle-Font-Bold="true">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1" runat="server" CommandName="SELECT" CommandArgument='<%# Eval("ID") %>'
                                ...
                                Visible='<%# isFloraInfoUpdateVisible(Eval("Authorize"),Eval("Approve"),Eval("ATM_Branch"), 
                                        Eval("PostingBY"), Eval("BankCode"),Eval("ApproveDT"), Eval("PublishDate")) %>'>
                                <img alt="" height="16px" width="16px" src='Images/edit-label.png' border="0" />
                            </asp:LinkButton>
                        </ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                SelectCommand="s_Dispute_Posting_Order_Pending" SelectCommandType="StoredProcedure"
                ...
                <SelectParameters>
                    ...
                    <asp:ControlParameter ControlID="ddlPosting" Name="Posting" PropertyName="SelectedValue" />
                </SelectParameters>
            </asp:SqlDataSource>
                ...
                <div style="background: green">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" BackColor="White" BorderColor="#DEDFDE"
                        ...
                        <Fields>
                            ...
                            <asp:TemplateField HeaderText="Flora Trace Number">
                                <ItemTemplate>
                                    <%# Eval("FloraTransactionNumber") %>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtFloraTransactionNumber" Width="200px" MaxLength="30" placeholder="Short 6 digit" runat="server" Text='<%# Bind("FloraTransactionNumber") %>'></asp:TextBox>
                                ...
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtFloraTransactionNumber" Width="200px" placeholder="Short 6 digit" MaxLength="30" runat="server" Text='<%# Bind("FloraTransactionNumber") %>'></asp:TextBox>
                                    <asp:FilteredTextBoxExtender runat="server" ID="FilteredTextBoxExtendertxtAccNo33qwe3"
                                        ValidChars="0123456789" TargetControlID="txtFloraTransactionNumber"></asp:FilteredTextBoxExtender>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFloraTransactionNumber" runat="server"
                                        ControlToValidate="txtFloraTransactionNumber" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
                            ...
                            <asp:TemplateField HeaderText="Flora Entry User Code">
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtFloraUserCode" runat="server" Text='<%# Bind("FloraUserCode") %>'
                                        MaxLength="6" Width="85px"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFloraUserCOde" runat="server"
                                        ControlToValidate="txtFloraUserCode" ErrorMessage="RequiredFieldValidator" ForeColor="Red">*</asp:RequiredFieldValidator>
                                </EditItemTemplate>
                                <InsertItemTemplate>
                                    <asp:TextBox ID="txtFloraUserCode" runat="server" Text='<%# Bind("FloraUserCode") %>'
                                        MaxLength="6" Width="85px"></asp:TextBox>
                            ...
                            <asp:TemplateField HeaderText="Flora Posting Date">
                                <ItemTemplate>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                SelectCommand="s_dispute_floraInfo_Browse" SelectCommandType="StoredProcedure"
                UpdateCommand="s_dispute_floraInfo_update"
                ...
                <UpdateParameters>
                    ...
                    <asp:Parameter Name="FloraUserCode" />
