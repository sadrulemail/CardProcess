...
public partial class Export_OnUs_Data : System.Web.UI.Page
{
    ...
    protected void cmdOK_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlCommand oCommand = new SqlCommand("s_POSReconcilationOnUsTrasactionReconcilation", oConn);
    ...
    {           
            ...
            //Downloading File
            string onus_download_file_name="OFS_On_Us"+DateTime.Now.Year + DateTime.Now.ToString("MM") + DateTime.Now.ToString("dd") + DateTime.Now.Hour + DateTime.Now.Minute+".txt";
