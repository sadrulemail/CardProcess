...
public partial class Export_ITCL_OffUS_Data : System.Web.UI.Page
{
    public DataSet ds=new DataSet();
    decimal TotalTransactionAmount = (decimal)0.0;
    decimal TotalPaymentAmount = (decimal)0.0;
    decimal TotalTBLCommissionAmount = (decimal)0.0;
    ...
    protected void cmdOK_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            SqlCommand oCommand = new SqlCommand("s_POSReconcilationITCLOfUSTrasactionReconcilation", oConn);
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            TotalTBLCommissionAmount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "TBLCommission"));
        ...
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            ...
            e.Row.Cells[4].Text = String.Format("{0:N2}", TotalTransactionAmount);
            e.Row.Cells[5].Text = String.Format("{0:N2}", TotalPaymentAmount);
            e.Row.Cells[6].Text = String.Format("{0:N2}", TotalTBLCommissionAmount);
            e.Row.Cells[7].Text = String.Format("{0:N2}", TotalITCLCommissionAmount);
        }
    }
    ...
    {           
            ...
            //Downloading File
            string onus_download_file_name="OFS_Off_Us"+DateTime.Now.Year + DateTime.Now.ToString("MM") + DateTime.Now.ToString("dd") + DateTime.Now.Hour + DateTime.Now.Minute+".txt";
