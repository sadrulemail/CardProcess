        ...
        <ContentTemplate>
            <asp:Panel ID="Panel1" runat="server">
                ...
                <div class="Panel1 ui-corner-all" style="display: inline-block; vertical-align: top">
                    ...
                    <asp:Button ID="Button1" runat="server" Text="Letter" Width="50px" CausesValidation="false"
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="White" AllowPaging="true"
                ...
                <Columns>
                    ...
                    <asp:CheckBoxField DataField="SMSEmailSend" HeaderText="SMS Email Send" />
            ...
            <asp:Label runat="server" ID="lblMsg" Text="" Visible="false"></asp:Label><br />
            <asp:Button runat="server" ID="downloadxlsx" Text="Download XLSX" OnClick="downloadxlsx_Click" Visible="false" />
