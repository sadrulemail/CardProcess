    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TabContainer runat="server" ID="tabContainer" CssClass="NewsTab" OnDemand="true"
                ...
                <asp:TabPanel runat="server" ID="tab2" style="min-height:500px">
                    <HeaderTemplate>
                        Upload History
                    </HeaderTemplate>
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" CssClass="Grid" AllowSorting="True"
                            ...
                            <Columns>                                
                                <asp:TemplateField HeaderText="View Data" SortExpression="ID">
                                    <ItemTemplate>
                                        <a href='CardsAnnualFeesView.aspx?batchid=<%# Eval("ID") %>' target="_blank" class="Link">
                                            <span style="color: blue">
                                                <%# Eval("ID") %></span></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField DataField="Type" HeaderText="Type" SortExpression="Type" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="FeesMonth" HeaderText="Fees Month" SortExpression="FeesMonth" ItemStyle-HorizontalAlign="Left" />
                                ...
                                <asp:TemplateField HeaderText="Authorize Info">
                                    <ItemTemplate>
                                       <%# (bool)Eval("Authorize") ? "<img src='Images/tick.png' width='24' >" : "" %>
                                ...
                                <asp:TemplateField HeaderText="Transfer Info">
                                    <ItemTemplate>
                                        <%# (bool)Eval("Transfer") ? "<img src='Images/tick.png' width='24' >" : "" %>
                                ...
                                <%--<asp:TemplateField HeaderText="Authorize">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="AuthorizeBtn" CommandArgument='<%# Eval("ID") %>' Visible='<%# (Eval("Authorize").ToString().ToUpper() == "TRUE" ? false : true) %>'
                                ...
                                <asp:TemplateField HeaderText="Transfer">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="TransferBtn" Visible='<%# (Eval("Transfer").ToString().ToUpper()
                                                == "FALSE"  && Eval("Authorize").ToString().ToUpper() == "TRUE" ? true : false) %>' CommandArgument='<%# Eval("ID") %>'
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDataUploadLog" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                            SelectCommand="s_CardChargeDeductionLog" SelectCommandType="StoredProcedure">
                            <SelectParameters>
