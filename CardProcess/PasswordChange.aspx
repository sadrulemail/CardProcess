                    ...
                    <td valign="top">
                        ...
                        <asp:Panel ID="Panel1" runat="server" Visible="false">
                            <div style="padding: 20px; text-align: center" class="Panel1">
                                ...
                                <asp:Button ID="cmdLogin" runat="server" Text="Login Again" Width="120px" Height="35px"
                                    OnClick="cmdLogin_Click" CausesValidation="false" />
                            </div>
                        </asp:Panel>
                        ...
                        <div class="group" style="font-family: 'lucida grande',tahoma,verdana,arial,sans-serif;
                            ...
                            <div style="white-space: nowrap; padding: 0 10px">
                                <ul style="padding-left: 20px">
                                    <asp:SqlDataSource ID="SqlDataSourcePasswordPolicy" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString %>"
