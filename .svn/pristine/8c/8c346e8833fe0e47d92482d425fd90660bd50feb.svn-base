...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="Grid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="BRPART" HeaderText="BR PART"
                SortExpression="BRPART" />
            ...
            <asp:TemplateField HeaderText="Image" SortExpression="ImageMsg">
                <ItemTemplate>
                     <div><%# (bool)Eval("ImageMsg") ? "<img src='Images/tick.png' width='24' >" : "" %></div>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
        SelectCommand="sp_ExportToITCL_Offline_xml" SelectCommandType="StoredProcedure" >
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="branches" Name="BranchCodes" Type="String"
                DefaultValue="*" />
            <asp:QueryStringParameter QueryStringField="batch" Name="BatchID" Type="Int32" />
