<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Export_Visa_OffUS_Data.aspx.cs" Inherits="Export_Visa_OffUS_Data" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#DEDFDE"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="CommissionAmount" HeaderText="Commission <br /> Amount" ReadOnly="True"
                        HtmlEncode="false" SortExpression="CommissionAmount" DataFormatString="{0:N2}"
                        ItemStyle-HorizontalAlign="Right" />
                </Columns>
