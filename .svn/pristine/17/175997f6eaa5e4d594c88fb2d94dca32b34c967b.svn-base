...
public partial class SMS_New : System.Web.UI.Page
{
    ...
    protected void lnkComplex_Click(object sender, EventArgs e)
    {
        txtMsg.Text = "This is a test SMS.\n(){}[];:'<>?/\\!@#$%^&*_+=~\"|";
    }
    protected void lnkSimple_Click(object sender, EventArgs e)
    {
        txtMsg.Text = "This is a test SMS.";
    }

    protected void lnlAshik_Click(object sender, EventArgs e)
    {
        txtTo.Text = "+8801730320272";
    }

    protected void lnlSadrul_Click(object sender, EventArgs e)
    {
        txtTo.Text = "+8801865074123";
    }
    protected void lnlImam_Click(object sender, EventArgs e)
    {
        txtTo.Text = "+8801552476716";
    }
}
