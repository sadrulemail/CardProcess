<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="PIN_Reissue_Branch.aspx.cs" Inherits="PIN_Reissue_Branch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="lblTitle" runat="server" Text="PIN Reissue"></asp:Label>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Request ID" SortExpression="ServiceRequestID">
                        <ItemTemplate>
                            <a href='New_Reissue_Request.aspx?id=<%# Eval("ServiceRequestID") %>' title="View" target="_blank">
                                <%# Eval("ServiceRequestID")%></span></a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center"/>
                    </asp:TemplateField>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                SelectCommand="s_PIN_Reissue_branch" SelectCommandType="StoredProcedure" OnSelected="SqlDataSource1_Selected">
                <SelectParameters>
