<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="CardMobileEmailAddressParse.aspx.cs" Inherits="CardMobileEmailAddressParse" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    Card Mobile & Email Address Parse
</asp:Content>
                ...
                <asp:TabPanel runat="server" ID="tab1">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                            SelectCommand="SELECT * FROM TempCardMobileEmailAddress WHERE ([SessionID] = @SessionID)" OnSelected="SqlDataSource1_Selected">
                            <SelectParameters>
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" CssClass="Grid" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="TotalEmail" HeaderText="Total Email" SortExpression="TotalEmail" ItemStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="TotalMobile" HeaderText="Total Mobile" SortExpression="TotalMobile"
                                ...
                                <asp:TemplateField HeaderText="Mobile" SortExpression="ID">
                                    <ItemTemplate>
                                        <a href='CardMobileEmailAddressView.aspx?batchid=<%# Eval("ID") %>&file=xlsx&type=M' target="_blank" class="Link">XLSX</a>|
                                        <a href='CardMobileEmailAddressView.aspx?batchid=<%# Eval("ID") %>&file=view&type=M' target="_blank" class="Link">View</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Email" SortExpression="ID">
                                    <ItemTemplate>
                                        <a href='CardMobileEmailAddressView.aspx?batchid=<%# Eval("ID") %>&file=xlsx&type=E' target="_blank" class="Link">XLSX</a>|
                                        <a href='CardMobileEmailAddressView.aspx?batchid=<%# Eval("ID") %>&file=view&type=E' target="_blank" class="Link">View</a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--<asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="DeleteBtn" Visible='<%# (Eval("Authorize").ToString().ToUpper() == "TRUE" ? false : true) %>' CommandArgument='<%# Eval("ID") %>'
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDataUploadLog" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                            SelectCommand="SELECT TOP 15 * FROM dbo.CardMobileEmailAddressLog ORDER BY ID desc" SelectCommandType="Text">
                            <%-- <SelectParameters>
