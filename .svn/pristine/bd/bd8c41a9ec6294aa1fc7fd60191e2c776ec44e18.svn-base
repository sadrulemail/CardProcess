...
public partial class PdfViewer : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            FileID = Request.QueryString["key"].ToString().Trim();
            Type = string.Format("{0}", Request.QueryString["type"]);
            ...
            if (!IsPostBack)
            {
                ...
                try
                {
                    ...
                    objCom.Parameters.Add("@AID", SqlDbType.BigInt).Value = AID;
                    objCom.Parameters.Add("@FileID", SqlDbType.VarChar).Value = FileID;
                    objCom.Parameters.Add("@Type", SqlDbType.VarChar).Value = Type;
        ...
        try
        {
            ...
            if (TotalPageInPDF > 0)
            {
                for (int i = 1; i <= TotalPageInPDF; i++)
                {
                    ...
                    img.Attributes.Add("LoadImg", "ShowImage.ashx?AID=" + AID + "&FileID=" + FileID + "&W=110&P=" + i + "&type=" + Type);
    ...
    private void LoadMainImagePage(string PageToLoad)
    {
        ...
        try
        {
            ...
            string url = "ShowImage.ashx?AID=" + AID + "&FileID=" + FileID + "&Z=1&P=" + PageToLoad + "&type=" + Type;
