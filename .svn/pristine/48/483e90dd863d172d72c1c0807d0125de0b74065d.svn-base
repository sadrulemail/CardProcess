    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="White" AllowPaging="true" Visible="false"
                ...
                <Columns>
                     <asp:BoundField DataField="BranchID" HeaderText="Branch ID" ReadOnly="true" ItemStyle-HorizontalAlign="Left">
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                     <asp:BoundField DataField="BranchName" HeaderText="Branch Name" ReadOnly="true" ItemStyle-HorizontalAlign="Left">
                        <ItemStyle HorizontalAlign="Left" />
                    </asp:BoundField>
                    <asp:BoundField DataField="TotalIssueCard" HeaderText="Total Issue Card" ReadOnly="true" ItemStyle-HorizontalAlign="Center">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>                 
                   <asp:BoundField DataField="TotalBranchReissueCard" HeaderText="Total Branch Reissue Card" ReadOnly="true" ItemStyle-HorizontalAlign="Center">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                    <asp:BoundField DataField="TotalIssueSupplCard" HeaderText="Total Issue Suppl. Card" ReadOnly="true" ItemStyle-HorizontalAlign="Center">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
                </Columns>
            ...
            <asp:Button ID="cmdExport" runat="server" Text="Download XLSX" Width="210px" OnClick="cmdExport_Click1"
                Height="30px" Visible="false" Font-Bold="true" />
        </ContentTemplate>
         <Triggers>
