    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:TabContainer runat="server" ID="tabContainer" CssClass="NewsTab" OnDemand="true"
                ActiveTabIndex="1" Width="100%" OnActiveTabChanged="tabContainer_ActiveTabChanged">
                ...
                <asp:TabPanel runat="server" ID="tab2">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="Grid" AllowSorting="True"
                           ...
                           OnRowCommand="GridView1_RowCommand" BorderWidth="1px" CellPadding="5" DataKeyNames="SL" DataSourceID="SqlDataSource2"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Card_ReissueFee" HeaderText="Fees" SortExpression="Card_ReissueFee">
                                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </asp:BoundField>
                               ...
                               <%-- <asp:TemplateField HeaderText="Branches" SortExpression="Branches">
                                ...
                                <asp:TemplateField HeaderText="Transfer">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="TransferBtn" CommandArgument='<%# Eval("SL") %>' Visible='<%# (decimal.Parse(Eval("Card_ReissueFee").ToString()) >0 && Eval("TRANSFER").ToString() == "False"  ? true : false) %>'
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                            SelectCommand="s_CardReissueSentLog_Browse" SelectCommandType="StoredProcedure" OnSelected="SqlDataSource2_Selected">
                            <SelectParameters>
                        ...
                        <asp:Label runat="server" ID="lblTotalReissue" Visible="False"></asp:Label>
                    </ContentTemplate>
                </asp:TabPanel>
