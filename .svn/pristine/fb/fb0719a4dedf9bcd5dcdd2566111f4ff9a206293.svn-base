<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Atm_Load_Summary.aspx.cs" Inherits="Atm_Load_Summary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:Label ID="lblTitle" runat="server" Text="ATM Load Summary"></asp:Label>
</asp:Content>
...
ORDER BY BranchName" EnableCaching="true" CacheDuration="600"></asp:SqlDataSource>
                                ...
                                <td>
                                    <asp:Button ID="cmdSearch" runat="server" Text="Show" Width="70px" Style="font-weight: 700" />
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="group" style="display: inline-block; padding: 5px; margin-bottom: 0">
                            Total No:
                            <asp:Label ID="lblTotalNo" runat="server" Text="0" Font-Size="Large"></asp:Label></div>
                    </td>
                    <td class="bold">
                        =
                    </td>
                    <td>
                        <div class="group" style="display: inline-block; padding: 5px; margin-bottom: 0">
                            Before Load:
                            <asp:Label ID="lblBeforeLoadAmount" runat="server" Text="0" Font-Size="Large"></asp:Label></div>
                    </td>
                    <td class="bold">
                        +
                    </td>
                    <td>
                        <div class="group" style="display: inline-block; padding: 5px; margin-bottom: 0">
                            Load:
                            <asp:Label ID="lblLoadAmount" runat="server" Text="0" Font-Size="Large"></asp:Label></div>
                    </td>
                    <td class="bold">
                        =
                    </td>
                    <td>
                        <div class="group" style="display: inline-block; padding: 5px; margin-bottom: 0">
                            After Load:
                            <asp:Label ID="lblAfterLoadAmount" runat="server" Text="0" Font-Size="Large"></asp:Label></div>
                    </td>
                </tr>
            </table>
            <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" CssClass="Grid"
                ...
                PagerSettings-Position="TopAndBottom" OnRowUpdated="GridView1_RowUpdated" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="AtmName" HeaderText="Atm Name" SortExpression="AtmName" />
                    <asp:BoundField DataField="TotalNo" HeaderText="Total No" SortExpression="TotalNo" ItemStyle-HorizontalAlign="Center" />
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CardDataConnectionString %>"
                SelectCommand="s_ATM_Single_Atm_Load_Summary" SelectCommandType="StoredProcedure"
