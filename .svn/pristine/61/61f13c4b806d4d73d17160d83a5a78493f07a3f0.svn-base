...
public partial class ReconciliationFile_Upload : System.Web.UI.Page
{
    ...
    {
        string trans_cat = DropDownList2.SelectedValue;
        ...
        using (SqlConnection oConn = new SqlConnection(oConnString))
        {
            ...
            using (SqlCommand oCommand = new SqlCommand("s_PosUploadBatch_Merge", oConn))
            {
                oCommand.CommandType = CommandType.StoredProcedure;
                oCommand.Parameters.AddWithValue("Type", trans_cat);
               ...
               // if(i>0)
                TrustControl1.ClientMsg("Upload Batch Merge Successfully.");
            ...
            foreach (string line in lines)
            {
                ...
                if (DateTime.TryParse(cols[0].Trim().ToString(), out dt))
                {
                    ...
                    dt_mtr.Rows.Add(HidPageID.Value, colss[0].Trim(), colss[1].Trim(), 
                        ...
                        Session["EMPID"].ToString(), trans_cat.Trim());
                }                
            }
