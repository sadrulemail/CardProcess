                    ...
                    <ContentTemplate>
                        ...
                        <table class="Panel1">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="dboRole" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                        DataSourceID="SqlDataSourceRole" DataTextField="RoleName" DataValueField="RoleID">
                                        <asp:ListItem Value="-1" Text="All Role"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:SqlDataSource ID="SqlDataSourceRole" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString %>"
                                        SelectCommand="SELECT  RoleID ,RoleName FROM dbo.Roles WHERE ApplicationID=19 AND Status=1">
                                    </asp:SqlDataSource>
                                </td>--%>
                                <td style="padding-left: 10px">
                                    Status:
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceUsers" runat="server" ConnectionString="<%$ ConnectionStrings:TblUserDBConnectionString %>"
                            ...
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="dboActive" PropertyName="SelectedValue" Name="Active"
                                    DefaultValue="*" />
                               <%-- <asp:ControlParameter ControlID="dboRole" PropertyName="SelectedValue" Name="RoleId"
                                    DefaultValue="-1" />--%>
                            </SelectParameters>
                        </asp:SqlDataSource>
                        <br />
