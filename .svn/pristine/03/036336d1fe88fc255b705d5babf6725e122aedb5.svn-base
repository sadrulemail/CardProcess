<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Card_Reissue.aspx.cs" Inherits="Card_Reissue" EnableSessionState="True" %>
            ...
            <div id="tabs" style="width: 900px;">
                ...
                <div id="upload">
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                        <table class="Panel1 ui-corner-all">
                            <tr>
                                <td>Select Accounts who have card transactions on and after:
                                </td>
                                <td>
                ...
                <div id="history">
                    <asp:GridView ID="GridView2" runat="server" AllowPaging="True" CssClass="Grid" AllowSorting="True"
                        ...
                        PagerSettings-Mode="NumericFirstLast" BorderColor="#DEDFDE" BorderStyle="Solid" OnRowCommand="GridView2_RowCommand"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="SMS Send" ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnSendSMS" runat="server" CommandName="SMSSend" Visible='<%# (Eval("SMS_Send").ToString().ToUpper()=="FALSE" ? true : false) %>'
                                        CommandArgument='<%# Eval("ID") %>' CssClass="bold">SMS Send</asp:LinkButton>
                                    <asp:ConfirmButtonExtender runat="server" ID="con_lnkConfirm" TargetControlID="btnSendSMS"
                                        ConfirmText="Do you want to SMS this Card?"></asp:ConfirmButtonExtender>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
