...
public partial class Card_AddEdit : System.Web.UI.Page
{
    ...
    protected void cmdGetAccount_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            while (oReader.Read())
            {
                ...
                ((TextBox)(DetailsView1.FindControl("txtCELLPHONE"))).Text = oReader["CELLPHONE"].ToString().Trim().ToUpper().Replace("+","");
                ((TextBox)(DetailsView1.FindControl("txtPHONE"))).Text = oReader["PHONE"].ToString().Trim().ToUpper().Replace("+", "");
    ...
    protected void DetailsView1_DataBound(object sender, EventArgs e)
    {
        ...
        try
        {
            Boolean PictureRequired = (bool)DataBinder.Eval(DetailsView1.DataItem, "PictureRequired");
        ...
        if (DetailsView1.CurrentMode == DetailsViewMode.ReadOnly)
        {
            try
            {
                ...
                if ((!SendToProcess && Session["BRANCHID"].ToString() == (((Label)(DetailsView1.FindControl("lblReqBranch"))).Text))
                    || (!SendToProcess && (Session["BRANCHID"].ToString() == "1" && (Session["DEPTID"].ToString() == "7" || Session["DEPTID"].ToString() == "90" || Session["DEPTID"].ToString() == "35"))))
                {
    ...
    protected void SqlDataSourceCardProcessAddEdit_Selected(object sender, SqlDataSourceStatusEventArgs e)
    {
        ...
        Panel11111.Visible = e.AffectedRows > 0;
