...
public partial class PIN_Export : System.Web.UI.Page
{
    ...
    protected void SqlDataSource6_Selected(object sender, SqlDataSourceStatusEventArgs e)
    {
        ...
        lblmsg1.Text = "Total Cards:" + e.AffectedRows.ToString();
        ...
        else
        {
            try
            {
                ...
                if (IDs.Length >= 2)
                {
                    ...
                    {
                        string Query = "s_Pin_Reissue_Export_New";
                        ...
                        using (SqlCommand cmd = new SqlCommand())
                        {
                            ...
                            SqlParameter Sql_Msg = new SqlParameter("@BatchNo", System.Data.SqlDbType.VarChar, 255);
                    ...
                    TrustControl1.ClientMsg("Please mark id for PIN issue.");
    ...
    protected void SqlDataSourceReExport_Selected(object sender, SqlDataSourceStatusEventArgs e)
    {
        ...
        Literal1.Text = string.Format("Download Batch-{0}: <a href='PIN_Export.aspx?type=xlsx&batch={0}' target='_blank' class='Link'>XLSX</a> | <a href='PIN_Export.aspx?type=dbf&batch={0}' target='_blank' class='Link'>DBF</a>", BatchID);
        GridView2.DataBind();
    ...
    {
        lblTotalPin.Visible = e.AffectedRows > 0;
        string Total = "";
        Total = e.Command.Parameters["@Total"].Value.ToString();
        lblTotalPin.Text = "<b>Total PIN(s):</b>" + Total.ToString();
    }
